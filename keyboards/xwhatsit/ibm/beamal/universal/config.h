...
#define MANUFACTURER Tom Wong-Cornall/Purdea Andrei/kmnov2017/listofoptions/Alectardy98
#define PRODUCT BEAMal
#define DESCRIPTION QMK firmware for the BEAMal keyboard using a 'universal' xwhatsit controller PCB
